...
p1 <- p1 +  theme(panel.border = element_rect(linetype = 'solid', colour = 'black',fill = NA,size = 0.7),
...
p4 <- p4 +  theme(panel.border = element_rect(linetype = 'solid', colour = 'black',fill = NA,size = 0.7),
                 panel.grid.major = element_blank(),
                 panel.grid.minor = element_blank())
```
...
p5 <- p5 +  theme(panel.border = element_rect(linetype = 'solid', colour = 'black',fill = NA,size = 0.7),
                 panel.grid.major = element_blank(),
                 panel.grid.minor = element_blank())
```
